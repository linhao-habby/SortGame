...
(function() {
    ...
    const GameConfig = {
        ...
        // ===== 难度曲线 =====
        // 每个阶段：[minOrders, maxOrders, colorCount, slotCount, slotCapacity, emptySlots, orderMin, orderMax]
        DIFFICULTY_STAGES: [
            { minOrders: 0,  maxOrders: 5,   colorCount: 3,        slotCount: 5,         capacity: 5,       emptySlots: 2,       orderRange: [3, 3],    label: '新手引导' },
            { minOrders: 6,  maxOrders: 15,  colorCount: 4,        slotCount: 6,         capacity: 5,       emptySlots: 2,       orderRange: [3, 4],    label: '入门' },
            { minOrders: 16, maxOrders: 30,  colorCountRange: [5, 6], slotCountRange: [6, 7], capacity: 5,  emptySlotsRange: [1, 2], orderRange: [3, 4], label: '中等' },
            { minOrders: 31, maxOrders: 50,  colorCountRange: [7, 8], slotCountRange: [7, 8], capacityRange: [5, 6], emptySlotsRange: [1, 2], orderRange: [4, 5], label: '进阶' },
            { minOrders: 51, maxOrders: 80,  colorCountRange: [8, 10], slotCountRange: [8, 9], capacity: 6,  emptySlots: 1,       orderRange: [4, 5],    label: '困难' },
            { minOrders: 81, maxOrders: Infinity, colorCountRange: [10, 12], slotCountRange: [9, 10], capacityRange: [6, 7], emptySlots: 1, orderRange: [5, 6], label: '极限' },
        ],
